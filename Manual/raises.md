...
Raises should not be tied to performance or tenure. Raises should be tied exclusively to contribution or output. In other words, "Treefrog does not give out raises" - we just "right-size" people commensurate with the industry-standard pay of their role compared to their output. 

The key confusion here is "inflationary raise" vs. "right-sizing due to  actually learning a great deal and now doing a whole different job".

#### Right-Sizing

At least once a year, each Pod Leader will look into the balance of industry standard value for your role and ensure we are paying you commensurate with industry standard salaries. Ideally, the Pod then right-sizes you to this level. However, the possiblity exists that your Pod is not actually generating a level of revenue that can support your industry standard comparitive value.
